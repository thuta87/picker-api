...
function post(req, res, next) {
    ...
    oracledb.getConnection(
		...
		" select ART_Code,BARCODE,ART_DESC,nvl(EX_TYPE,1),trunc(EXPIRE_DATE),:req_qty as qty, current_date"+
                ...
                var rtn_results= results.rows || msg; 
                    ...
                    connection.release(function(err) {
                        if (err) {
                            ...
                            console.log("POST /add_Edited_Expire/" + req.body.uname + "/"+req.body.barcode+"/"+req.body.r_qty+"/"+req.body.cdate+" : Connection released " + rtn_results.message );    
                        }
                    });
                });
        }
