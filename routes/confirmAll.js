    ...
    oracledb.getConnection(
        ...
        function(err, connection){
            ...
            connection.execute("Update INTERF_IN.EXPIRE_LIST Set Doubt=1 , MODIFIED_DATE=current_date"+
                            " Where SUBSTR(uname,1,length(uname)-1) = SUBSTR(:uname,1,length(:uname)-1) AND NVL(Doubt,0)=0 AND Barcode Like :barcode",
                {
                ...
                console.log("bcode : "+req.body.barcode);
                    ...
                    connection.release(function(err) {
                        if (err) {
                            ...
                            console.log("PUT /confirmAll/?uname=" + req.body.uname + "&barcode="+req.body.barcode+" : Connection released");    
                        }                        
                    });
                }
            );
