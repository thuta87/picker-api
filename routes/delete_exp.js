...
function put(req, res, next) {
    ...
    oracledb.getConnection(
        ...
        function(err, connection){
            ...
            connection.execute("Update INTERF_IN.EXPIRE_LIST Set Inactive=1"+
                            " Where Uname=:uname AND Barcode=:barcode AND Inactive=0"+
                ...
                console.log("date : "+req.body.cdate);
                    ...
                    connection.release(function(err) {
                        if (err) {
                            ...
                            console.log("PUT /expire_delete/?uname=" + req.body.uname + "&cdate=" + req.body.cdate + "&barcode=" + req.body.barcode + " : Connection released and already updated");    
                        }                        
                    });
                }
            );
