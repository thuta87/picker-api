...
function get(req, res, next) {
    ...
    oracledb.getConnection(
        ...
        function(err, connection){
            ...
            connection.execute("select ART_Code,BARCODE,ART_DESC,nvl(EX_TYPE,1) as estatus,trunc(EXPIRE_DATE) as edate,SUM(REQ_QTY) as total_qty"+
		    ...
		    console.log(results.rows);
                    ...
                    connection.release(function(err) {
                        if (err) {
                            ...
                            console.log("GET /get_expire_detail_Date/?barcode=" + req.query.barcode + "&uname=" + req.query.uname+"&cdate="+req.query.cdate+": Connection released");    
                        }                        
                    });
                }
            );
